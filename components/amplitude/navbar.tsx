      ...
      <div className="flex items-center justify-between h-16 px-6 lg:px-16 max-w-[1400px] mx-auto">
        ...
        <div className="flex items-center gap-3">
          <div className="flex bg-amp-gray-10 rounded-md overflow-hidden border border-amp-gray-20">
            <button onClick={()=>setLocale("primary")} className={`px-3.5 py-1.5 text-xs font-semibold transition-all duration-200 ${locale==="primary"?"bg-amp-blue text-white":"text-amp-gray-60 hover:text-amp-gray-100"}`}>{t.localeName}</button>
